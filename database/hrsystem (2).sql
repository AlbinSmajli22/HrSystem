...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 12, 2023 at 01:05 AM
...
INSERT INTO `timeoff` (`timeoff_id`, `annual_leave`, `child_born`, `death_of_amily_member`, `moving_day`, `wedding_day`, `sick_leave`, `User_ID`) VALUES
(1, 20, 3, 5, 1, 5, 20, 5);
...
--
ALTER TABLE `timeoff`
  MODIFY `timeoff_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
