    ...
    <div class="content">
        ...
        <div class="requestBody">
            <div class="requestTableHead">
                <h5>
                    Employee Leave Yearly Allowances
                </h5>
            </div>
            ...
            <form action="" method="post">
                ...
                <div class="paginationn">
                    <ul>
                        <li><a href="allowance.php?page=1">
                                << </a>
                        </li>
                        <li><a href="allowance.php?page=<?php echo $previous == 0 ? 1 : $previous ?>">
                                < </a>
                        </li>
                        <?php for ($i = 1; $i <= $total_page; $i++) {
                            ...
                            if ($i >= $previous_2 && $i <= $next_2) {
                                ?>
                                <li><a href="allowance.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php }
                        } ?>
                        <li><a
                                href="allowance.php?page=<?php echo $next > $total_page ? $total_page : $next ?>">></a>
                        </li>
                        <li><a href="allowance.php?page=<?php echo $total_page ?>">>></a></li>
                    </ul>
                </div>
                <div>
