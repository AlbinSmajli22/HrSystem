            ...
            <div class="categories-tables">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="beginning-part">
                                                            ...
                                                            <div class="drop-downs">
                                                                ...
                                                                <div class="row-2">
                                                                    <label for="timezone<?= $location['location_id'] ?>">Timezone</label>
                                                                    <select class="form-control timezone-select" id="timezone<?= $location['location_id'] ?>"></select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                ...
                <div class="categories-tables-footer">
                    ...
                    <p>You can allocate your employees to a particulat location, and set permission based on them.
                        You can also change timezones for each location if your employees are spread across different
                        regions. </p>
                </div>
            </div>
            <div class="categories-tables">
                            ...
                            <?php foreach ($NewsCategories as $NewsCategory): ?>
                                <tr>
                                    ...
                                    <div class="modal fade-delete-NewsCategoriesModal"
                                        id="deleteNewsCategoriesModal<?= $NewsCategory['newscategory_id'] ?>" tabindex="-1"
                                        aria-labelledby="deleteNewsCategoriesModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content animated slideInTop">
                                                <div class="modal-header-delete">
                                                    <button type="button" class="close" data-bs-dismiss="modal"
                                                        aria-label="Close">×</button>
                                                    <h6 class="modal-title" id="exampleModalLabel">Delete News Category</h6>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="delete-part-two">
                                    ...
                                    <div class="modal fade-edit-NewsCategoriesModal"
                                        id="editNewsCategoriesModal<?= $NewsCategory['newscategory_id'] ?>" tabindex="-1"
                                        aria-labelledby="editNewsCategoriesModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content animated slideInTop">
                                                <form action="categoriesLogic.php" method="post"
                                                    enctype="multipart/form-data">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-bs-dismiss="modal"
                                                            aria-label="Close">×</button>
                                                        <h4 class="modal-title" id="exampleModalLabel">Edit News Category</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="beginning-part">
                                                            <div class="inputs">
                                                                <input type="hidden" name="newscategory_id" id="newscategory_id"
