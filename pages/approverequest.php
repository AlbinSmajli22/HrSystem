...
<table class="recentLeave">
    ...
    <div class="paginationn">
        <ul >
              <li><a href="approverequest.php?page=1"><<</a></li>
              <li><a href="approverequest.php?page=<?php echo $previous == 0 ? 1 : $previous ?>"><</a></li>
            ...
            <?php } }?>
            <li><a href="approverequest.php?page=<?php echo $next > $total_page ? $total_page : $next ?>">></a></li>
